...
//using std::endl;
//
//int timeToMinutes(const string& timeStr) {		//Nick Function
...
//}
//
//void splitInterval(const string& interval, string& start, string& end) {	//Nick Function
//	size_t dash = interval.find('-');
//	start = interval.substr(0, dash);
//	end = interval.substr(dash + 1);
//}
//
//bool intervalsOverlap(const string& interval1, const string& interval2) {	//Nick Function
//	string s1, e1, s2, e2;
